...
var channelData = [{
	...
	messages: [{
		...
		embedData: {
			title: 'GLITCH',
			pill: 'hsl(202, 35%, 68%)',
			thumb: 'https://media.discordapp.net/attachments/733664384340983809/735557784871108648/gen.png?width=115&height=115',
			image: 'https://media.discordapp.net/attachments/733664384340983809/735557784871108648/gen.png?width=115&height=115'
		}
	}]
}, {
	name: 'music',
